<x-layout>
    <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('faktur.update_check_alasan_2') }}" method="POST">
                @csrf
                        ...
                        <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-12 justify-evenly">
                            ...
                            <div class="sm:col-span-5">
                                <div class="grid grid-cols-12 gap-x-4">
                                    ...
                                    <div class="sm:col-span-12">
                                        <label for="check_alasan_2" class="block text-sm font-medium leading-6 text-gray-900">Alasan</label>
                                        <div class="mt-2">
                                            <textarea class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" name="check_alasan_2" id="check_alasan_2" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

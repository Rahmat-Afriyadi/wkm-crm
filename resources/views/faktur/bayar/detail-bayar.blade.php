                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-12 justify-evenly">
                            ...
                            <div class="sm:col-span-5">
                                <div class="grid grid-cols-12 gap-x-4 ">
                                    ...
                                    <div class="sm:col-span-6">
                                        ...
                                        <div class="mt-2">
                                            <input disabled  type="text" value="{{$i->no_tt}}" name="no-tanda-terima" id="no-tanda-terima" autocomplete="family-name" class="px-2 block w-full bg-gray-200 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                    </div>
                                    ...
                                    <div class="sm:col-span-6">
                                        ...
                                        <div class="mt-2">
                                            <input disabled  type="text" value="{{$i->rt}}" id="rt" autocomplete="given-name" class="px-2 block w-full bg-gray-200 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                    </div>
                            ...
                            <div class="col-span-full">
                                <label for="alamat" class="block text-sm font-medium leading-6 text-gray-900">Alamat</label>
                                <div class="mt-2">
                                    <input disabled  type="text" value="{{$i->alamat}}" name="alamat" id="alamat" autocomplete="alamat" class="px-2 block w-full bg-gray-200 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            ...
                            <div class="mt-2">
                                <input disabled  type="text" value="{{$i->kota}}" name="kota" id="kota" autocomplete="address-level2" class="px-2 block w-full bg-gray-200 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                <label for="tgl-bayar" class="block text-sm font-medium leading-6 text-gray-900">Tgl Bayar</label>
                                <div class="relative max-w-sm">
                                    ...
                                    <input id="datepicker-autohide" value="{{$i->tgl_byr}}" datepicker-format="yyyy-mm-dd" name="tgl_bayar" datepicker datepicker-autohide type="text" class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6 pl-9 mt-2" placeholder="Select date">
                                </div>
                            </div>

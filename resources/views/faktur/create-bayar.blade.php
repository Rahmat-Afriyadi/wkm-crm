<x-layout>
    <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('faktur.update_bayar') }}" method="POST">
                @csrf
                                ...
                                <div class="grid grid-cols-12 gap-x-4 ">
                                    ...
                                    <div class="sm:col-span-12">
                                        ...
                                        <div class="relative mt-2">
                                            ...
                                            <input id="datepicker-autohide" value="" datepicker-format="yyyy-mm-dd" name="tgl_byr_cs" datepicker datepicker-autohide type="text" class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-9" placeholder="Select date">
                                        </div>
                                    </div>
